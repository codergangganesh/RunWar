...
export const PrivacyScreen: React.FC<PrivacyScreenProps> = ({
  ...
  const handleClearAllData = async () => {
    ...
    try {
      ...
      localStorage.removeItem('runwar_offline_queue');
    ...
    <div className="p-4 space-y-5 animate-fade-in">
      ...
      <div className="rounded-3xl bg-slate-900 border border-slate-800 p-5 shadow-xl space-y-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-sm font-bold text-white">Our Privacy Commitment</h3>
            <p className="text-xs text-slate-400">You have complete ownership of your fitness data.</p>
          </div>
        </div>
        ...
        <div className="space-y-3 pt-2 border-t border-slate-800/80 text-xs text-slate-300">
          <div className="flex items-start gap-2.5">
            ...
            <div>
              <span className="font-bold text-white">Active Workout Only: </span>
          ...
          <div className="flex items-start gap-2.5">
            ...
            <div>
              <span className="font-bold text-white">Zero Third-Party Tracking: </span>
              Your location coordinates and personal metrics are never sold or shared with advertising networks.
            </div>
          </div>

          <div className="flex items-start gap-2.5">
            <Database size={16} className="text-lime-400 shrink-0 mt-0.5" />
            <div>
              <span className="font-bold text-white">Secure InsForge Cloud: </span>
      ...
      <div className="rounded-3xl bg-slate-900 border border-slate-800 p-5 shadow-xl space-y-3">
        ...
        <button
          ...
          className="w-full p-3.5 rounded-2xl bg-rose-500/10 hover:bg-rose-500/20 border border-rose-500/30 text-rose-400 font-bold text-xs flex items-center justify-center gap-2 active:scale-95 transition-all"
        >
          <Trash2 size={16} />
        ...
        <button
          onClick={onSignOut}
          className="w-full p-3.5 rounded-2xl bg-slate-950 border border-slate-800 hover:border-slate-700 text-slate-400 hover:text-white font-semibold text-xs flex items-center justify-center gap-2 active:scale-95 transition-all"
        >
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/80 backdrop-blur-md animate-fade-in">
          <div className="w-full max-w-sm rounded-3xl bg-slate-900 border border-slate-800 p-6 shadow-2xl space-y-4">
            <div className="flex items-center gap-2.5 text-rose-400">
              ...
              <h3 className="text-base font-black text-white">Delete All Workouts?</h3>
            </div>
            ...
            <div className="flex flex-col gap-2 pt-2">
              ...
              <button
                ...
                className="w-full py-2.5 px-4 rounded-xl bg-slate-800 text-slate-300 font-semibold text-xs"
              >
                Cancel
              </button>
            </div>
